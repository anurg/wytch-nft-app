  ...
  return (
    <div className="mintDetails">
      <div>
        ...
        <div id="price">
          <span className="price2">Price: 0.1 SOL</span>
        </div>
        {_showWL1 ? (
          <div id="price">
        ...
        {_showWL2 ? (
          <div id="price">
            <span className="price2"> Mint Limit - 10</span>
          </div>
        ) : null}
                ...
                <>
                  {selectedType === "type1" && (
                    <div className="typesMain2">
                      ...
                      <div className="valuesDiv">
                        {_value0_1 === "" ? (
                          <div onClick={eyes0}>Sleepy</div>
                        ) : (
                          <div onClick={_eyes0} id="selectedT">
                            ✔ Sleepy
                          </div>
                        )}

                        {_value1_1 === "" ? (
                          <div onClick={eyes1}>Out</div>
                        ) : (
                          <div onClick={_eyes1} id="selectedT">
                            ✔ Out
                          </div>
                        )}

                        {_value2_1 === "" ? (
                          <div onClick={eyes2}>Cloudy</div>
                        ) : (
                          <div onClick={_eyes2} id="selectedT">
                            ✔ Cloudy
                          </div>
                        )}

                        {_value3_1 === "" ? (
                          <div onClick={eyes3}>Angry</div>
                        ) : (
                          <div onClick={_eyes3} id="selectedT">
                            ✔ Angry
                          </div>
                        )}

                        {_value4_1 === "" ? (
                          <div onClick={eyes4}>Hypnotised</div>
                        ) : (
                          <div onClick={_eyes4} id="selectedT">
                            ✔ Hypnotised
                          </div>
                        )}

                        {_value5_1 === "" ? (
                          <div onClick={eyes5}>Ethereum</div>
                        ) : (
                          <div onClick={_eyes5} id="selectedT">
                            ✔ Ethereum
                          </div>
                        )}

                        {_value6_1 === "" ? (
                          <div onClick={eyes6}>Sunglasses</div>
                        ) : (
                          <div onClick={_eyes6} id="selectedT">
                            ✔ Sunglasses
                          </div>
                        )}

                        {_value7_1 === "" ? (
                          <div onClick={eyes7}>Laser beam</div>
                        ) : (
                          <div onClick={_eyes7} id="selectedT">
                            ✔ Laser beam
                          </div>
                        )}

                        {_value8_1 === "" ? (
                          <div onClick={eyes8}>Laughing</div>
                        ) : (
                          <div onClick={_eyes8} id="selectedT">
                            ✔ Laughing
                          </div>
                        )}
                      </div>
                  ...
                  {selectedType === "type2" && (
                    <div className="typesMain2">
                      ...
                      <div className="valuesDiv">
                        {_value0_2 === "" ? (
                          <div onClick={mouth0}>Candy</div>
                        ) : (
                          <div onClick={_mouth0} id="selectedT">
                            ✔ Candy
                          </div>
                        )}

                        {_value1_2 === "" ? (
                          <div onClick={mouth1}>Zip</div>
                        ) : (
                          <div onClick={_mouth1} id="selectedT">
                            ✔ Zip
                          </div>
                        )}

                        {_value2_2 === "" ? (
                          <div onClick={mouth2}>Whistle</div>
                        ) : (
                          <div onClick={_mouth2} id="selectedT">
                            ✔ Whistle
                          </div>
                        )}

                        {_value3_2 === "" ? (
                          <div onClick={mouth3}>Cigar</div>
                        ) : (
                          <div onClick={_mouth3} id="selectedT">
                            ✔ Cigar
                          </div>
                        )}

                        {_value4_2 === "" ? (
                          <div onClick={mouth4}>Balloon</div>
                        ) : (
                          <div onClick={_mouth4} id="selectedT">
                            ✔ Balloon
                          </div>
                        )}
                      </div>
                  ...
                  {selectedType === "type3" && (
                    <div className="typesMain2">
                      ...
                      <div className="valuesDiv">
                        {_value0_3 === "" ? (
                          <div onClick={hat0}>Witch</div>
                        ) : (
                          <div onClick={_hat0} id="selectedT">
                            ✔ Witch
                          </div>
                        )}

                        {_value1_3 === "" ? (
                          <div onClick={hat1}>Top</div>
                        ) : (
                          <div onClick={_hat1} id="selectedT">
                            ✔ Top
                          </div>
                        )}

                        {_value2_3 === "" ? (
                          <div onClick={hat2}>Sailor</div>
                        ) : (
                          <div onClick={_hat2} id="selectedT">
                            ✔ Sailor
                          </div>
                        )}

                        {_value3_3 === "" ? (
                          <div onClick={hat3}>Army</div>
                        ) : (
                          <div onClick={_hat3} id="selectedT">
                            ✔ Army
                          </div>
                        )}

                        {_value4_3 === "" ? (
                          <div onClick={hat4}>Pilot</div>
                        ) : (
                          <div onClick={_hat4} id="selectedT">
                            ✔ Pilot
                          </div>
                        )}

                        {_value5_3 === "" ? (
                          <div onClick={hat5}>Viking</div>
                        ) : (
                          <div onClick={_hat5} id="selectedT">
                            ✔ Viking
                          </div>
                        )}

                        {_value6_3 === "" ? (
                          <div onClick={hat6}>Captain</div>
                        ) : (
                          <div onClick={_hat6} id="selectedT">
                            ✔ Captain
                          </div>
                        )}

                        {_value7_3 === "" ? (
                          <div onClick={hat7}>Spider</div>
                        ) : (
                          <div onClick={_hat7} id="selectedT">
                            ✔ Spider
                          </div>
                        )}

                        {_value8_3 === "" ? (
                          <div onClick={hat8}>Police</div>
                        ) : (
                          <div onClick={_hat8} id="selectedT">
                            ✔ Police
                          </div>
                        )}

                        {_value9_3 === "" ? (
                          <div onClick={hat9}>Cowboy</div>
                        ) : (
                          <div onClick={_hat9} id="selectedT">
                            ✔ Cowboy
                          </div>
                        )}
                      </div>
                  ...
                  {selectedType === "type4" && (
                    <div className="typesMain2">
                      ...
                      <div className="valuesDiv">
                        {_value0_4 === "" ? (
                          <div onClick={Color0}>Green</div>
                        ) : (
                          <div onClick={_Color0} id="selectedT">
                            ✔ Green
                          </div>
                        )}

                        {_value1_4 === "" ? (
                          <div onClick={Color1}>Blue</div>
                        ) : (
                          <div onClick={_Color1} id="selectedT">
                            ✔ Blue
                          </div>
                        )}

                        {_value2_4 === "" ? (
                          <div onClick={Color2}>Yellow</div>
                        ) : (
                          <div onClick={_Color2} id="selectedT">
                            ✔ Yellow
                          </div>
                        )}

                        {_value3_4 === "" ? (
                          <div onClick={Color3}>Red</div>
                        ) : (
                          <div onClick={_Color3} id="selectedT">
                            ✔ Red
                          </div>
                        )}

                        {_value4_4 === "" ? (
                          <div onClick={Color4}>Orange</div>
                        ) : (
                          <div onClick={_Color4} id="selectedT">
                            ✔ Orange
                          </div>
                        )}

                        {_value5_4 === "" ? (
                          <div onClick={Color5}>Violet</div>
                        ) : (
                          <div onClick={_Color5} id="selectedT">
                            ✔ Violet
                          </div>
                        )}

                        {_value6_4 === "" ? (
                          <div onClick={Color6}>Nude</div>
                        ) : (
                          <div onClick={_Color6} id="selectedT">
                            ✔ Nude
                          </div>
                        )}

                        {_value7_4 === "" ? (
                          <div onClick={Color7}>Brown</div>
                        ) : (
                          <div onClick={_Color7} id="selectedT">
                            ✔ Brown
                          </div>
                        )}

                        {_value8_4 === "" ? (
                          <div onClick={Color8}>Pink</div>
                        ) : (
                          <div onClick={_Color8} id="selectedT">
                            ✔ Pink
                          </div>
                        )}

                        {_value9_4 === "" ? (
                          <div onClick={Color9}>Grey</div>
                        ) : (
                          <div onClick={_Color9} id="selectedT">
                            ✔ Grey
                          </div>
                        )}
                      </div>
