                            ...
                            {showMyNFTs.length > 0 ? (
                                showMyNFTs.map((data, index) => (
                                    <div className='eachImg' key={index}>
                                        ...
                                        <p>{data.name}</p>
                                        <a href={data.nftMetadata} target="_blank" rel="noopener noreferrer">
                                            <div className='meta'>
                                                Metadata <img id="link" src="https://cdn-icons-png.flaticon.com/128/7268/7268615.png" alt="Link icon" />
                                            </div>
                                        </a>
                                    </div>
                                ))
                            ) : (
                                <div id='price'><span className='price2'>No NFTs available</span></div>
                            )}

                        </div>
                    </div> :

                    <div id='price'><span className='price2'>Please connect the wallet address</span></div>
